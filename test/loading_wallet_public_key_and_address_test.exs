defmodule LoadPublicKeyAndAddressTest do
  ...
  test "validate master public key and address 1" do
    ...
    assert mnemonic == {:ok, "bulk\r property\r loop\r pen\r fuel\r wild\r gorilla\r say\r pond\r rigid\r torch\r budget"}
    {:ok, public_key} = Wallet.get_public_key("test/test_wallets/wallet--2017-11-1-16-35-48", "password")
  ...
  test "validate master public key and address 2" do
    ...
    assert mnemonic == {:ok, "able\r actress\r bring\r rebuild\r clean\r timber\r flash\r grace\r tribe\r trial\r income\r brother"}
    {:ok, public_key} = Wallet.get_public_key("test/test_wallets/wallet--2017-11-1-16-35-57", "password")
   ...
   test "validate master public key and address 3" do
    ...
    assert mnemonic == {:ok, "tenant\r thrive\r marble\r magnet\r chief\r taxi\r enhance\r verb\r session\r saddle\r venue\r during"}
    {:ok, public_key} = Wallet.get_public_key("test/test_wallets/wallet--2017-11-1-16-35-58", "password")
  ...
  test "validate master public key and address 4" do
    ...
    assert mnemonic == {:ok, "drum\r pledge\r man\r fame\r sort\r favorite\r doll\r color\r device\r remove\r angry\r jelly"}
    {:ok, public_key} = Wallet.get_public_key("test/test_wallets/wallet--2017-11-1-16-35-59", "password")
  ...
  test "validate master public key and address 5" do
    ...
    assert mnemonic == {:ok, "year\r wage\r suggest\r cream\r good\r length\r umbrella\r ridge\r winter\r giant\r blast\r improve"}
    {:ok, public_key} = Wallet.get_public_key("test/test_wallets/wallet--2017-11-1-16-36-0", "password")
  ...
  test "validate master public key and address 6" do
    ...
    assert mnemonic == {:ok, "inhale\r step\r culture\r mesh\r barrel\r dice\r deputy\r rural\r sweet\r spend\r dry\r quality"}
    {:ok, public_key} = Wallet.get_public_key("test/test_wallets/wallet--2017-11-1-16-36-1", "password")
    ...
    assert public_key == public_key?
    {:ok, address} = Wallet.get_address("test/test_wallets/wallet--2017-11-1-16-36-1", "password")
  ...
  test "validate master public key and address 7" do
    ...
    assert mnemonic =={:ok, "slot\r memory\r drink\r square\r yard\r student\r erupt\r chronic\r solution\r pass\r furnace\r dad"}
    {:ok, public_key} = Wallet.get_public_key("test/test_wallets/wallet--2017-11-1-16-36-2", "password")
    ...
    assert public_key == public_key?
    {:ok, address} = Wallet.get_address("test/test_wallets/wallet--2017-11-1-16-36-2", "password")
  ...
  test "validate master public key and address 8" do
    ...
    assert mnemonic == {:ok, "all\r pride\r wish\r loyal\r version\r evoke\r neck\r question\r melt\r thought\r ladder\r club"}
    {:ok, public_key} = Wallet.get_public_key("test/test_wallets/wallet--2017-11-1-16-36-3", "password")
    ...
    assert public_key == public_key?
    {:ok, address} = Wallet.get_address("test/test_wallets/wallet--2017-11-1-16-36-3", "password")
  ...
  test "validate master public key and address 9" do
    ...
    assert mnemonic == {:ok, "solve\r tourist\r puzzle\r wasp\r wheat\r syrup\r crunch\r unusual\r boy\r maid\r ill\r click"}
    {:ok, public_key} = Wallet.get_public_key("test/test_wallets/wallet--2017-11-1-16-36-20", "password")
    ...
    assert public_key == public_key?
    {:ok, address} = Wallet.get_address("test/test_wallets/wallet--2017-11-1-16-36-20", "password")
  ...
  test "validate master public key and address 10" do
    ...
    assert mnemonic == {:ok, "leave\r quick\r have\r cash\r insane\r resemble\r juice\r duty\r vault\r poem\r ramp\r spirit"}
    {:ok, public_key} = Wallet.get_public_key("test/test_wallets/wallet--2017-11-1-16-37-15", "password")
    ...
    assert public_key == public_key?
    {:ok, address} = Wallet.get_address("test/test_wallets/wallet--2017-11-1-16-37-15", "password")
