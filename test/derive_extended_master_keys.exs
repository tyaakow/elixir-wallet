defmodule DeriveExtendedMasterKeys do
  use ExUnit.Case


  ## Test Vector 1 from BIP-32

  test "derive extended master public key 1" do
    ...
    = KeyPair.derive_extend_pub_key(seed)
  end

  test "derive extended master private key 1" do
    seed = "000102030405060708090a0b0c0d0e0f"
    assert "xprv9s21ZrQH143K3QTDL4LXw2F7HEK3wJUD2nW2nRk4stbPy6cq3jPPqjiChkVvvNKmPGJxWUtg6LnF5kejMRNNU3TGtRBeJgk33yuGBxrMPHi"
    = KeyPair.derive_extend_priv_key(seed)
  end


  ## Test Vector 2 from BIP-32

  test "derive extended master public key 2" do
  ...
  test "derive extended master private key 2" do
    seed = "fffcf9f6f3f0edeae7e4e1dedbd8d5d2cfccc9c6c3c0bdbab7b4b1aeaba8a5a29f9c999693908d8a8784817e7b7875726f6c696663605d5a5754514e4b484542"
  ...
  test "derive extended master public key 3" do
  ...
  test "derive extended master private key 3" do
    seed = "4b381541583be4423346c643850da4b320e46a87ae3d2a4e6da11eba819cd4acba45d239319ac14f863b8d5ab5a0d0c64d2e8a1e7d1457df2e5a3c51c73235be"
