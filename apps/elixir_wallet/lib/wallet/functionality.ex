defmodule Wallet.Functionality do
  require Logger
  ...
  alias Wallet.Mnemonic, as: Mnemonic
  alias Wallet.GenerateIndexes, as: Indexes
  alias Wallet.Cypher, as: Cypher
  alias Wallet.KeyPeir, as: KeyPairx

  @doc """
  Creates a wallet file
  ## Examples
      iex> Wallet.Functionality.create_wallet("pass")
  ...
  def create_wallet(password \\ "password") do
  ...
  ## Examples
      iex> Wallet.Functionality.load_wallet_file("wallet--2017-10-31-14-54-39", "password")
	  {:ok,
  ...
  Gets the public key
  ## Examples
      iex> Wallet.Functionality.get_public_key("wallet--2017-10-31-14-54-39", "password")
  ...
  ## Examples
      iex> Wallet.Functionality.get_address("wallet--2017-10-31-14-54-39", "password")
